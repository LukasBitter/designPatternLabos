...
int main()
{
	...
	do
	{
		...
		{
		case 1:
			Meal = CAbstractFactory::CreateMeal(Cuisson);
			break;
		case 2:
			Meal = CAbstractFactory::CreateMeal(Vapeur);
			break;
		case 3:
			Meal = CAbstractFactory::CreateMeal(Salad);
			break;
		case 4:
			Meal = CAbstractFactory::CreateMeal(Potage);
			break;
		default:
			break;
		}
